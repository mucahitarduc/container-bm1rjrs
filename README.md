...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bm1rjrs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bm1rjrs.containers.anotherwebservice.com/
...
```
git clone git@github.com:mucahitarduc/container-bm1rjrs.git
cd container-bm1rjrs
```
...
```
docker attach container-bm1rjrs
```
